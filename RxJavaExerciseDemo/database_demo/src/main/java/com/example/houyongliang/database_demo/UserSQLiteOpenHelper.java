...
/**
 * Created by houyongliang on 2018/3/22 15:13.
 * Function(功能):
 */
...
public class UserSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public UserSQLiteOpenHelper(Context context, String name, int version) {
        this(context, name, null, version);
    }

    public UserSQLiteOpenHelper(Context context, String name) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql = "create table user(id integer primary key autoincrement,name varchar(64),age varchar(64))";
        db.execSQL(sql);
